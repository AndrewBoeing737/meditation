    ...
    public void playSong() {
        ...
        try {
            ...
            if (!wasPlaying || mediaPlayer == null) {
                ...
                fabPlayPause.setImageDrawable(ContextCompat.getDrawable(Music.this, android.R.drawable.ic_media_pause));

                //Открытие файла
                AssetFileDescriptor descriptor = getAssets().openFd("Ozzy_Osbourne_-_Black_Rain_b64f0d282.mp3");
                ...
                if (mediaPlayer != null && isPlay && wasPlaying) {
                    ...
                    fabPlayPause.setImageDrawable(ContextCompat.getDrawable(Music.this, android.R.drawable.ic_media_play));
