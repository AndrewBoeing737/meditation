...
public class Music3 extends AppCompatActivity implements Runnable {
    ...
    public void playSong() {
        ...
        try {
            ...
            if (!wasPlaying || mediaPlayer == null) {
                ...
                fabPlayPause.setImageDrawable(ContextCompat.getDrawable(Music3.this, android.R.drawable.ic_media_pause));

                //Открытие файла
                AssetFileDescriptor descriptor = getAssets().openFd("Ozzy_Osbourne_-_Bark_at_the_Moon_b64f0d257.mp3");
                ...
                if (mediaPlayer != null && isPlay && wasPlaying) {
                    ...
                    fabPlayPause.setImageDrawable(ContextCompat.getDrawable(Music3.this, android.R.drawable.ic_media_play));
